package com.cd.coe.sns.endpoint;

import com.cd.coe.sns.bean.Message;
import com.cd.coe.sns.bean.NotificationMessage;
import com.cd.coe.sns.bean.SubscriptionMessage;
...
public class SNSEndpoint extends HttpServlet{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Log log = LogFactoryUtil.getLog(SNSEndpoint.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Get the message type header.
		   ...
		   StringBuilder builder = new StringBuilder();
		    ...
		    //builder.append("{\"Type\": \"Notification\",\"MessageId\": \"ABC001\", \"Message\": \"Test Message\", \"Subject\": \"Message Subject\"}");
		    
		    Message msg;
		    
		    if (messagetype.equals("SubscriptionConfirmation")){
		    	msg = new SubscriptionMessage();		    	
		    	ObjectMapper mapper = new ObjectMapper();
				msg = mapper.readValue(builder.toString(), SubscriptionMessage.class);
		    }else {
				msg = new NotificationMessage();
				if(messagetype.equals("Notification")){
					ObjectMapper mapper = new ObjectMapper();
					msg = mapper.readValue(builder.toString(), NotificationMessage.class);
				}
				//msg = readMessageFromJson(builder.toString());
		    } 
	...
	//Build the string to sign for Notification messages.
		 public static String buildNotificationStringToSign( Message msg) {
		   ...
		   log.info("The Signing String is:"+stringToSign);
		   return stringToSign;
		 }
